...
func NewResourceManager(clientManager ClientManagerInterface) *ResourceManager {
	return &ResourceManager{
		...
		appManageStore:          clientManager.AppManageStore(),
		myAppManageStore:        clientManager.MyAppManageStore(),
	}
}
...
func (r *ResourceManager) GetMyAppManage(id string) (*model.AppManage, error) {
	return r.myAppManageStore.GetMyAppManage(id)
}
func (r *ResourceManager) CreateMyAppManage(appManage *model.AppManage) (*model.AppManage, error) {
	return r.myAppManageStore.CreateMyAppManage(appManage)
}
