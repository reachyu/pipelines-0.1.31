...
func (f *FakeClientManager) AppManageStore() storage.AppManageStoreInterface {
	return  f.appManageStore
}

func (f *FakeClientManager) MyAppManageStore() storage.MyAppManageStoreInterface {
	return  f.myAppManageStore
}
...
func NewFakeClientManager(time util.TimeInterface, uuid util.UUIDGeneratorInterface) (
	...
	return &FakeClientManager{
		...
		time:                        time,
		uuid:                        uuid,
		appManageStore:              storage.NewAppManageStore(db, time, uuid),
		myAppManageStore:              storage.NewMyAppManageStore(db, time, uuid),
	}, nil
}
